...
function avatar_process_user(&$error, $custom_userdata = false, $can_upload = null)
{
	...
	$data = array(
		...
		'usegravatar'	=> request_var('gravatar', 0), // This may be bool, but handling it as int is easier.
		'gravatarsize'	=> request_var('gravatar_size', 0),
	);
	...
	$error = validate_data($data, array(
		...
		'gravatarsize'	=> array('string', true, 1, 3),
	));
