...
<?php $_leader_count = (isset($this->_tpldata['leader'])) ? sizeof($this->_tpldata['leader']) : 0;if ($_leader_count) {for ($_leader_i = 0; $_leader_i < $_leader_count; ++$_leader_i){$_leader_val = &$this->_tpldata['leader'][$_leader_i]; if ($_leader_val['S_FIRST_ROW']) {  ?>
	...
	<tr>
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>" width="6%" align="center" nowrap="nowrap"><?php if ($this->_rootref['S_CHANGE_DEFAULT']) {  ?><input type="radio" class="radio" name="default"<?php if ($_leader_val['S_GROUP_DEFAULT']) {  ?> checked="checked"<?php } ?> value="<?php echo $_leader_val['GROUP_ID']; ?>" /><?php } ?></td>
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>">
		...
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>" width="6%" align="center" nowrap="nowrap"><?php if (! $_leader_val['GROUP_SPECIAL']) {  ?><input type="radio" class="radio" name="selected" value="<?php echo $_leader_val['GROUP_ID']; ?>" /><?php } ?></td>
	</tr>
<?php }} $_member_count = (isset($this->_tpldata['member'])) ? sizeof($this->_tpldata['member']) : 0;if ($_member_count) {for ($_member_i = 0; $_member_i < $_member_count; ++$_member_i){$_member_val = &$this->_tpldata['member'][$_member_i]; if ($_member_val['S_FIRST_ROW']) {  ?>
	...
	<tr>
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>" width="6%" align="center" nowrap="nowrap"><?php if ($this->_rootref['S_CHANGE_DEFAULT']) {  ?><input type="radio" class="radio" name="default"<?php if ($_member_val['S_GROUP_DEFAULT']) {  ?> checked="checked"<?php } ?> value="<?php echo $_member_val['GROUP_ID']; ?>" /><?php } ?></td>
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>">
		...
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>" width="6%" align="center" nowrap="nowrap"><?php if (! $_member_val['GROUP_SPECIAL']) {  ?><input type="radio" class="radio" name="selected" value="<?php echo $_member_val['GROUP_ID']; ?>" /><?php } ?></td>
	</tr>
<?php }} $_pending_count = (isset($this->_tpldata['pending'])) ? sizeof($this->_tpldata['pending']) : 0;if ($_pending_count) {for ($_pending_i = 0; $_pending_i < $_pending_count; ++$_pending_i){$_pending_val = &$this->_tpldata['pending'][$_pending_i]; if ($_pending_val['S_FIRST_ROW']) {  ?>
	...
	<tr>
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>" width="6%" align="center" nowrap="nowrap">&nbsp;</td>
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>">
		...
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>" width="6%" align="center" nowrap="nowrap"><?php if (! $_pending_val['GROUP_SPECIAL']) {  ?><input type="radio" class="radio" name="selected" value="<?php echo $_pending_val['GROUP_ID']; ?>" /><?php } ?></td>
	</tr>
<?php }} $_nonmember_count = (isset($this->_tpldata['nonmember'])) ? sizeof($this->_tpldata['nonmember']) : 0;if ($_nonmember_count) {for ($_nonmember_i = 0; $_nonmember_i < $_nonmember_count; ++$_nonmember_i){$_nonmember_val = &$this->_tpldata['nonmember'][$_nonmember_i]; if ($_nonmember_val['S_FIRST_ROW']) {  ?>
	...
	<tr>
		...
		<td class="<?php if (!($_leader_val['S_ROW_COUNT'] & 1)  ) {  ?>row1<?php } else { ?>row2<?php } ?>" width="6%" align="center" nowrap="nowrap"><?php if ($_nonmember_val['S_CAN_JOIN']) {  ?><input type="radio" class="radio" name="selected" value="<?php echo $_nonmember_val['GROUP_ID']; ?>" /><?php } ?></td>
	</tr>
<?php }} ?>
