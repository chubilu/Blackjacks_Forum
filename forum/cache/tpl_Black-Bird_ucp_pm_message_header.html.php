			...
			<?php if ($this->_rootref['TOTAL_MESSAGES']) {  ?>
				...
				<tr>
					...
					<?php if ($this->_rootref['FOLDER_MAX_MESSAGES'] != 0) {  ?>
						...
						<td class="gensmall2" nowrap="nowrap" width="100%">&nbsp;[ <b><?php echo (isset($this->_rootref['FOLDER_CUR_MESSAGES'])) ? $this->_rootref['FOLDER_CUR_MESSAGES'] : ''; ?></b>/<?php echo (isset($this->_rootref['FOLDER_MAX_MESSAGES'])) ? $this->_rootref['FOLDER_MAX_MESSAGES'] : ''; ?> <?php echo ((isset($this->_rootref['L_MESSAGES'])) ? $this->_rootref['L_MESSAGES'] : ((isset($user->lang['MESSAGES'])) ? $user->lang['MESSAGES'] : '{ MESSAGES }')); ?> (<?php echo (isset($this->_rootref['FOLDER_PERCENT'])) ? $this->_rootref['FOLDER_PERCENT'] : ''; ?>%) ]&nbsp;</td>
					<?php } else { ?>

						<td class="gensmall2" nowrap="nowrap" width="100%">&nbsp;[ <b><?php echo (isset($this->_rootref['FOLDER_CUR_MESSAGES'])) ? $this->_rootref['FOLDER_CUR_MESSAGES'] : ''; ?></b> <?php echo ((isset($this->_rootref['L_MESSAGES'])) ? $this->_rootref['L_MESSAGES'] : ((isset($user->lang['MESSAGES'])) ? $user->lang['MESSAGES'] : '{ MESSAGES }')); ?> ]&nbsp;</td>					
					<?php } ?>
