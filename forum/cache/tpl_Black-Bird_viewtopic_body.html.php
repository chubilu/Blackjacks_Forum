...
<table class="tablebg" width="100%" cellspacing="0"> 
    <tr>
		<td class="row5"><h2><span class="titles" style="text-color:#CFCFCF;"><?php echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; ?></span></h2></td>
	</tr>
</table>
...
<div id="pagecontent">
	...
	<tr>
		<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>" valign="middle" width="190px">
		...
		<?php if ($this->_rootref['TOTAL_POSTS']) {  ?>
			...
			<td class="gensmall3" valign="middle" nowrap="nowrap"><?php echo (isset($this->_rootref['PAGE_NUMBER'])) ? $this->_rootref['PAGE_NUMBER'] : ''; ?>&nbsp; &nbsp;[ <?php echo (isset($this->_rootref['TOTAL_POSTS'])) ? $this->_rootref['TOTAL_POSTS'] : ''; ?> ]<br /></td>
	...
	<?php } else { ?>
		...
		<tr>
			...
			<?php if ($_postrow_val['RANK_TITLE']) {  ?>
				...
				<tr>
					<td class="postrang"><?php echo $_postrow_val['RANK_TITLE']; ?></td>
				</tr>
		...
		<tr>
            ...
            <td class="<?php if (!($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?> row1<?php } else { ?> row2<?php } ?>">
			    <div id="topic">
			        <div style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>;">
					    <?php if ($_postrow_val['ONLINE_IMG']) {  ?><a class="line"><span><?php echo $_postrow_val['ONLINE_IMG']; ?></span></a><?php } if ($_postrow_val['U_POST_AUTHOR']) {  ?><a class="prof" href="<?php echo $_postrow_val['U_POST_AUTHOR']; ?>"><span><?php echo (isset($this->_rootref['PROFILE_IMG'])) ? $this->_rootref['PROFILE_IMG'] : ''; ?></span></a><?php } if ($_postrow_val['U_PM']) {  ?><a class="mp" href="<?php echo $_postrow_val['U_PM']; ?>"><span><?php echo (isset($this->_rootref['PM_IMG'])) ? $this->_rootref['PM_IMG'] : ''; ?></span></a><?php } if ($_postrow_val['U_EMAIL']) {  ?><a class="mail" href="<?php echo $_postrow_val['U_EMAIL']; ?>"><span><?php echo (isset($this->_rootref['EMAIL_IMG'])) ? $this->_rootref['EMAIL_IMG'] : ''; ?></span></a><?php } ?>

					</div>
					<div class="gensmall" style="float: <?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>;">
					    <?php if (! $this->_rootref['S_IS_BOT']) {  if ($_postrow_val['U_EDIT']) {  ?><a class="edi" href="<?php echo $_postrow_val['U_EDIT']; ?>"><span><?php echo (isset($this->_rootref['EDIT_IMG'])) ? $this->_rootref['EDIT_IMG'] : ''; ?></span></a><?php } if ($_postrow_val['U_QUOTE']) {  ?><a class="cite" href="<?php echo $_postrow_val['U_QUOTE']; ?>"><span><?php echo (isset($this->_rootref['QUOTE_IMG'])) ? $this->_rootref['QUOTE_IMG'] : ''; ?></span></a><?php } } ?>
...
<br clear="all" />
<?php if ($this->_rootref['S_QUICK_REPLY']) {  $this->_tpl_include('quickreply_editor.html'); } if ($this->_rootref['S_DISPLAY_ONLINE_LIST']) {  ?>
...
<table width="100%" cellspacing="1">
<tr>
	<td width="40%" valign="top" nowrap="nowrap" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>"><?php if ($this->_rootref['S_TOPIC_MOD']) {  ?><form method="post" action="<?php echo (isset($this->_rootref['S_MOD_ACTION'])) ? $this->_rootref['S_MOD_ACTION'] : ''; ?>"><span class="gensmall3"><?php echo ((isset($this->_rootref['L_QUICK_MOD'])) ? $this->_rootref['L_QUICK_MOD'] : ((isset($user->lang['QUICK_MOD'])) ? $user->lang['QUICK_MOD'] : '{ QUICK_MOD }')); ?>:</span> <?php echo (isset($this->_rootref['S_TOPIC_MOD'])) ? $this->_rootref['S_TOPIC_MOD'] : ''; ?> <input class="btnlite" type="submit" value="<?php echo ((isset($this->_rootref['L_GO'])) ? $this->_rootref['L_GO'] : ((isset($user->lang['GO'])) ? $user->lang['GO'] : '{ GO }')); ?>" /></form><?php } ?></td>
	<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>" valign="top" nowrap="nowrap"><span class="gensmall3"><?php $_rules_count = (isset($this->_tpldata['rules'])) ? sizeof($this->_tpldata['rules']) : 0;if ($_rules_count) {for ($_rules_i = 0; $_rules_i < $_rules_count; ++$_rules_i){$_rules_val = &$this->_tpldata['rules'][$_rules_i]; echo $_rules_val['RULE']; ?><br /><?php }} ?></span></td>
</tr>
</table>
