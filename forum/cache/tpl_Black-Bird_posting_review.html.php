					...
					<tr>
						<td>
							...
							<tr valign="middle">
								...
								<td class="gensmall2" nowrap="nowrap"><b><?php echo ((isset($this->_rootref['L_POSTED'])) ? $this->_rootref['L_POSTED'] : ((isset($user->lang['POSTED'])) ? $user->lang['POSTED'] : '{ POSTED }')); ?>:</b> <?php echo $_post_review_row_val['POST_DATE']; ?></td>
							</tr>
							</table>
						</td>
					</tr>
