	...
	<tr>
		<td class="row1">
			...
			<tr>
				...
				<td width="100%"><?php if ($this->_rootref['U_EMAIL']) {  ?><a class="mail" href="<?php echo (isset($this->_rootref['U_EMAIL'])) ? $this->_rootref['U_EMAIL'] : ''; ?>"><span><?php echo (isset($this->_rootref['EMAIL_IMG'])) ? $this->_rootref['EMAIL_IMG'] : ''; ?></span></a><?php } ?></td>
			</tr>
			<?php if ($this->_rootref['U_PM']) {  ?>
				...
				<tr>
					...
					<td><a class="mp" href="<?php echo (isset($this->_rootref['U_PM'])) ? $this->_rootref['U_PM'] : ''; ?>"><span><?php echo (isset($this->_rootref['PM_IMG'])) ? $this->_rootref['PM_IMG'] : ''; ?></span></a></td>
				</tr>
			<?php } ?>
			...
			<tr>
				...
				<td><?php if ($this->_rootref['U_MSN']) {  ?><a class="msn" href="<?php echo (isset($this->_rootref['U_MSN'])) ? $this->_rootref['U_MSN'] : ''; ?>" onclick="popup(this.href, 550, 320); return false"><span><?php echo (isset($this->_rootref['MSN_IMG'])) ? $this->_rootref['MSN_IMG'] : ''; ?></span></a><?php } else if ($this->_rootref['USER_MSN']) {  echo (isset($this->_rootref['USER_MSN'])) ? $this->_rootref['USER_MSN'] : ''; } ?></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><?php if ($this->_rootref['U_AIM']) {  ?><a class="aim" href="<?php echo (isset($this->_rootref['U_AIM'])) ? $this->_rootref['U_AIM'] : ''; ?>" onclick="popup(this.href, 550, 320); return false"><span><?php echo (isset($this->_rootref['AIM_IMG'])) ? $this->_rootref['AIM_IMG'] : ''; ?></span></a><?php } else if ($this->_rootref['USER_AIM']) {  echo (isset($this->_rootref['USER_AIM'])) ? $this->_rootref['USER_AIM'] : ''; } ?></td>
			</tr>
			<tr>
				...
				<td><?php if ($this->_rootref['U_ICQ']) {  ?><a class="icq" href="<?php echo (isset($this->_rootref['U_ICQ'])) ? $this->_rootref['U_ICQ'] : ''; ?>" onclick="popup(this.href, 550, 320); return false"><span><?php echo (isset($this->_rootref['ICQ_IMG'])) ? $this->_rootref['ICQ_IMG'] : ''; ?></span></a><?php } else if ($this->_rootref['USER_ICQ']) {  echo (isset($this->_rootref['USER_ICQ'])) ? $this->_rootref['USER_ICQ'] : ''; } ?></td>
			</tr>
			<tr>
