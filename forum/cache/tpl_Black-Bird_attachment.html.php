<?php if (!defined('IN_PHPBB')) exit; $__file_count = (isset($this->_tpldata['_file'])) ? sizeof($this->_tpldata['_file']) : 0;if ($__file_count) {for ($__file_i = 0; $__file_i < $__file_count; ++$__file_i){$__file_val = &$this->_tpldata['_file'][$__file_i]; if ($__file_val['S_DENIED']) {  ?>
	...
	<?php } else { if ($__file_val['COMMENT']) {  ?>
			...
			<span class="gensmall2"><b><?php echo ((isset($this->_rootref['L_FILE_COMMENT'])) ? $this->_rootref['L_FILE_COMMENT'] : ((isset($user->lang['FILE_COMMENT'])) ? $user->lang['FILE_COMMENT'] : '{ FILE_COMMENT }')); ?>:</b> <?php echo $__file_val['COMMENT']; ?></span><br />
		<?php } if ($__file_val['S_THUMBNAIL']) {  ?>
			...
			<span class="gensmall2"><?php echo $__file_val['DOWNLOAD_NAME']; ?> [ <?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?> | <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?> ]</span>
