...
<div id="pageheader">
<br clear="all" />
	<?php if ($this->_rootref['TOPIC_TITLE'] || $this->_rootref['FORUM_NAME']) {  } if ($this->_rootref['U_MCP']) {  ?>

 <table class="tablebg" width="100%" cellspacing="0">
    <tr>
<td class="row5"><h2><?php if ($this->_rootref['TOPIC_TITLE']) {  ?><a class="titles" href="<?php echo (isset($this->_rootref['U_VIEW_TOPIC'])) ? $this->_rootref['U_VIEW_TOPIC'] : ''; ?>"><?php echo (isset($this->_rootref['TOPIC_TITLE'])) ? $this->_rootref['TOPIC_TITLE'] : ''; ?></a><?php } else { ?><a class="titles" href="<?php echo (isset($this->_rootref['U_VIEW_FORUM'])) ? $this->_rootref['U_VIEW_FORUM'] : ''; ?>"><?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; ?></a><?php } ?></h2><?php if ($this->_rootref['U_MCP_FORUM']) {  ?><td class="row5"><div style="float:right;"><a href="<?php echo (isset($this->_rootref['U_MCP_FORUM'])) ? $this->_rootref['U_MCP_FORUM'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MODERATE_FORUM'])) ? $this->_rootref['L_MODERATE_FORUM'] : ((isset($user->lang['MODERATE_FORUM'])) ? $user->lang['MODERATE_FORUM'] : '{ MODERATE_FORUM }')); ?></a><?php } if ($this->_rootref['U_MCP_TOPIC']) {  ?> | <a href="<?php echo (isset($this->_rootref['U_MCP_TOPIC'])) ? $this->_rootref['U_MCP_TOPIC'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MODERATE_TOPIC'])) ? $this->_rootref['L_MODERATE_TOPIC'] : ((isset($user->lang['MODERATE_TOPIC'])) ? $user->lang['MODERATE_TOPIC'] : '{ MODERATE_TOPIC }')); ?></a><?php } if ($this->_rootref['U_MCP_POST']) {  ?> | <a href="<?php echo (isset($this->_rootref['U_MCP_POST'])) ? $this->_rootref['U_MCP_POST'] : ''; ?>"><?php echo ((isset($this->_rootref['L_MODERATE_POST'])) ? $this->_rootref['L_MODERATE_POST'] : ((isset($user->lang['MODERATE_POST'])) ? $user->lang['MODERATE_POST'] : '{ MODERATE_POST }')); ?></a><?php } ?></div></td></td></tr></table>
