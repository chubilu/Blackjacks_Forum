...
<tr>
	<th colspan="2" style="text-align: left;">&nbsp;<?php echo $_forumrow_val['FORUM_NAME']; ?>&nbsp;</th>
...
<?php } if ($_forumrow_val['S_IS_CAT']) {  } else if ($_forumrow_val['S_IS_LINK']) {  ?>
		...
		<tr>
			<td class="row_h" width="50" align="center"><?php echo $_forumrow_val['FORUM_FOLDER_IMG']; ?></td>
			<td class="row1">
