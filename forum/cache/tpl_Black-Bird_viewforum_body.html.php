...
<?php } if ($this->_rootref['S_DISPLAY_ACTIVE']) {  ?>
	...
	<tr>
		<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>
			<th colspan="3" style="text-align:left;">&nbsp;<?php echo ((isset($this->_rootref['L_TOPICS'])) ? $this->_rootref['L_TOPICS'] : ((isset($user->lang['TOPICS'])) ? $user->lang['TOPICS'] : '{ TOPICS }')); ?>&nbsp;</th>
		<?php } else { ?>
	...
	<?php $_topicrow_count = (isset($this->_tpldata['topicrow'])) ? sizeof($this->_tpldata['topicrow']) : 0;if ($_topicrow_count) {for ($_topicrow_i = 0; $_topicrow_i < $_topicrow_count; ++$_topicrow_i){$_topicrow_val = &$this->_tpldata['topicrow'][$_topicrow_i]; ?>
		...
		<tr>
			<td class="row_h" width="25" align="center"><?php echo $_topicrow_val['TOPIC_FOLDER_IMG']; ?></td>
			<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>
...
<?php } if ($this->_rootref['S_IS_POSTABLE'] || $this->_rootref['S_NO_READ_ACCESS']) {  ?>
    ...
    <tr>
		<td class="row5"><h2><span class="titles" style="color:#7F7F7F;"><?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; ?></span></h2></td>
</tr>
</table>
<?php if ($this->_rootref['MODERATORS']) {  ?>
         <table class="tablebg" width="100%" cellspacing="0"> 
         <tr>
		<td class="row8"><p class="moderators"><?php if ($this->_rootref['S_SINGLE_MODERATOR']) {  echo ((isset($this->_rootref['L_MODERATOR'])) ? $this->_rootref['L_MODERATOR'] : ((isset($user->lang['MODERATOR'])) ? $user->lang['MODERATOR'] : '{ MODERATOR }')); } else { echo ((isset($this->_rootref['L_MODERATORS'])) ? $this->_rootref['L_MODERATORS'] : ((isset($user->lang['MODERATORS'])) ? $user->lang['MODERATORS'] : '{ MODERATORS }')); } ?>: <?php echo (isset($this->_rootref['MODERATORS'])) ? $this->_rootref['MODERATORS'] : ''; ?></p></td></tr>
        </table>
...
<?php } if ($this->_rootref['S_DISPLAY_POST_INFO'] || $this->_rootref['TOTAL_TOPICS']) {  ?>
		...
		<tr>
			<?php if ($this->_rootref['S_DISPLAY_POST_INFO'] && ! $this->_rootref['S_IS_BOT']) {  ?>
				<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>" valign="middle">
				<a class="<?php if ($this->_rootref['S_IS_LOCKED']) {  ?>locked-icon<?php } else { ?>post-icon<?php } ?>" href="<?php echo (isset($this->_rootref['U_POST_NEW_TOPIC'])) ? $this->_rootref['U_POST_NEW_TOPIC'] : ''; ?>" title="<?php if ($this->_rootref['S_IS_LOCKED']) {  echo ((isset($this->_rootref['L_FORUM_LOCKED'])) ? $this->_rootref['L_FORUM_LOCKED'] : ((isset($user->lang['FORUM_LOCKED'])) ? $user->lang['FORUM_LOCKED'] : '{ FORUM_LOCKED }')); } else { echo ((isset($this->_rootref['L_POST_TOPIC'])) ? $this->_rootref['L_POST_TOPIC'] : ((isset($user->lang['POST_TOPIC'])) ? $user->lang['POST_TOPIC'] : '{ POST_TOPIC }')); } ?>"><span><?php if ($this->_rootref['S_IS_LOCKED']) {  echo ((isset($this->_rootref['L_FORUM_LOCKED'])) ? $this->_rootref['L_FORUM_LOCKED'] : ((isset($user->lang['FORUM_LOCKED'])) ? $user->lang['FORUM_LOCKED'] : '{ FORUM_LOCKED }')); } else { echo ((isset($this->_rootref['L_POST_TOPIC'])) ? $this->_rootref['L_POST_TOPIC'] : ((isset($user->lang['POST_TOPIC'])) ? $user->lang['POST_TOPIC'] : '{ POST_TOPIC }')); } ?></span></a>
				</td>
			<?php } if ($this->_rootref['TOTAL_TOPICS']) {  ?>
				...
				<td class="gensmall3" nowrap="nowrap">&nbsp;[ <?php echo (isset($this->_rootref['TOTAL_TOPICS'])) ? $this->_rootref['TOTAL_TOPICS'] : ''; ?> ]&nbsp;</td>
	...
	<?php } if (! $this->_rootref['S_DISPLAY_ACTIVE'] && ( $this->_rootref['S_IS_POSTABLE'] || sizeof($this->_tpldata['topicrow']) )) {  ?>
		...
		<tr align="center">
			<?php if ($this->_rootref['S_TOPIC_ICONS']) {  ?>
				<td class="row7" colspan="7">
			<?php } else { ?>
				<td class="row7" colspan="6">
			<?php } ?>
...
<?php if ($this->_rootref['S_DISPLAY_ONLINE_LIST']) {  ?>
	...
	<table class="tablebg" width="100%" cellspacing="1">
	<tr>
		<td class="cat2"><h4><?php echo ((isset($this->_rootref['L_WHO_IS_ONLINE'])) ? $this->_rootref['L_WHO_IS_ONLINE'] : ((isset($user->lang['WHO_IS_ONLINE'])) ? $user->lang['WHO_IS_ONLINE'] : '{ WHO_IS_ONLINE }')); ?></h4></td>
	</tr>
	<tr>
		<td class="row1"><p class="gensmall2"><?php echo (isset($this->_rootref['LOGGED_IN_USER_LIST'])) ? $this->_rootref['LOGGED_IN_USER_LIST'] : ''; ?></p></td>
	</tr>
	</table>
	...
	<tr>
		<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>" valign="top">
			...
			<tr>
				...
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_UNREAD_POSTS'])) ? $this->_rootref['L_UNREAD_POSTS'] : ((isset($user->lang['UNREAD_POSTS'])) ? $user->lang['UNREAD_POSTS'] : '{ UNREAD_POSTS }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td width="20" style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_IMG'])) ? $this->_rootref['FOLDER_IMG'] : ''; ?></td>
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_NO_UNREAD_POSTS'])) ? $this->_rootref['L_NO_UNREAD_POSTS'] : ((isset($user->lang['NO_UNREAD_POSTS'])) ? $user->lang['NO_UNREAD_POSTS'] : '{ NO_UNREAD_POSTS }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				...
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_ICON_ANNOUNCEMENT'])) ? $this->_rootref['L_ICON_ANNOUNCEMENT'] : ((isset($user->lang['ICON_ANNOUNCEMENT'])) ? $user->lang['ICON_ANNOUNCEMENT'] : '{ ICON_ANNOUNCEMENT }')); ?></td>
			</tr>
			<tr>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_HOT_UNREAD_IMG'])) ? $this->_rootref['FOLDER_HOT_UNREAD_IMG'] : ''; ?></td>
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_UNREAD_POSTS_HOT'])) ? $this->_rootref['L_UNREAD_POSTS_HOT'] : ((isset($user->lang['UNREAD_POSTS_HOT'])) ? $user->lang['UNREAD_POSTS_HOT'] : '{ UNREAD_POSTS_HOT }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_HOT_IMG'])) ? $this->_rootref['FOLDER_HOT_IMG'] : ''; ?></td>
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_NO_UNREAD_POSTS_HOT'])) ? $this->_rootref['L_NO_UNREAD_POSTS_HOT'] : ((isset($user->lang['NO_UNREAD_POSTS_HOT'])) ? $user->lang['NO_UNREAD_POSTS_HOT'] : '{ NO_UNREAD_POSTS_HOT }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_STICKY_IMG'])) ? $this->_rootref['FOLDER_STICKY_IMG'] : ''; ?></td>
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_ICON_STICKY'])) ? $this->_rootref['L_ICON_STICKY'] : ((isset($user->lang['ICON_STICKY'])) ? $user->lang['ICON_STICKY'] : '{ ICON_STICKY }')); ?></td>			
			</tr>
			<tr>
				...
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_UNREAD_POSTS_LOCKED'])) ? $this->_rootref['L_UNREAD_POSTS_LOCKED'] : ((isset($user->lang['UNREAD_POSTS_LOCKED'])) ? $user->lang['UNREAD_POSTS_LOCKED'] : '{ UNREAD_POSTS_LOCKED }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_LOCKED_IMG'])) ? $this->_rootref['FOLDER_LOCKED_IMG'] : ''; ?></td>
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_NO_UNREAD_POSTS_LOCKED'])) ? $this->_rootref['L_NO_UNREAD_POSTS_LOCKED'] : ((isset($user->lang['NO_UNREAD_POSTS_LOCKED'])) ? $user->lang['NO_UNREAD_POSTS_LOCKED'] : '{ NO_UNREAD_POSTS_LOCKED }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_MOVED_IMG'])) ? $this->_rootref['FOLDER_MOVED_IMG'] : ''; ?></td>
				<td class="gensmall3"><?php echo ((isset($this->_rootref['L_TOPIC_MOVED'])) ? $this->_rootref['L_TOPIC_MOVED'] : ((isset($user->lang['TOPIC_MOVED'])) ? $user->lang['TOPIC_MOVED'] : '{ TOPIC_MOVED }')); ?></td>
			</tr>
			</table>
		</td>
		<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>"><span class="gensmall">
		<span class="gensmall3 right">
		<?php if ($this->_rootref['S_WATCH_FORUM_LINK'] && ! $this->_rootref['S_IS_BOT'] && $this->_rootref['U_MARK_TOPICS']) {  ?> | <?php } if ($this->_rootref['S_WATCH_FORUM_LINK'] && ! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo (isset($this->_rootref['S_WATCH_FORUM_LINK'])) ? $this->_rootref['S_WATCH_FORUM_LINK'] : ''; ?>"><?php echo (isset($this->_rootref['S_WATCH_FORUM_TITLE'])) ? $this->_rootref['S_WATCH_FORUM_TITLE'] : ''; ?></a><?php } ?>
		<br /><?php $_rules_count = (isset($this->_tpldata['rules'])) ? sizeof($this->_tpldata['rules']) : 0;if ($_rules_count) {for ($_rules_i = 0; $_rules_i < $_rules_count; ++$_rules_i){$_rules_val = &$this->_tpldata['rules'][$_rules_i]; echo $_rules_val['RULE']; ?><br /><?php }} ?>
		</span></span></td>
	</tr>
	</table>
<?php } ?>
