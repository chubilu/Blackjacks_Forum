...
<div id="pagecontent">
	...
	<?php $_recentsearch_count = (isset($this->_tpldata['recentsearch'])) ? sizeof($this->_tpldata['recentsearch']) : 0;if ($_recentsearch_count) {for ($_recentsearch_i = 0; $_recentsearch_i < $_recentsearch_count; ++$_recentsearch_i){$_recentsearch_val = &$this->_tpldata['recentsearch'][$_recentsearch_i]; ?>
		...
		<tr>
			...
			<td class="genmed<?php if (!($_recentsearch_val['S_ROW_COUNT'] & 1)  ) {  ?> row1<?php } else { ?> row2<?php } ?>" style="padding: 4px;" width="70%"><a href="<?php echo $_recentsearch_val['U_KEYWORDS']; ?>"><?php echo $_recentsearch_val['KEYWORDS']; ?></a></td>
			<td class="genmed<?php if (!($_recentsearch_val['S_ROW_COUNT'] & 1)  ) {  ?> row1<?php } else { ?> row2<?php } ?>" style="padding: 4px;" width="30%" align="center"><?php echo $_recentsearch_val['TIME']; ?></td>
		</tr>
	<?php }} ?>
