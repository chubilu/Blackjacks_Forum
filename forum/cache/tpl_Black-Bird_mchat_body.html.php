...
<div class="forabg">
	<div class="inner"><span class="corners-top"><span><a name="mChat"></a></span></span>
		<ul class="topiclist">
			<li class="header">
				<dl class="icon">
					<dt><?php if ($this->_rootref['MCHAT_ARCHIVE_MODE']) {  echo ((isset($this->_rootref['L_MCHAT_ARCHIVE_PAGE'])) ? $this->_rootref['L_MCHAT_ARCHIVE_PAGE'] : ((isset($user->lang['MCHAT_ARCHIVE_PAGE'])) ? $user->lang['MCHAT_ARCHIVE_PAGE'] : '{ MCHAT_ARCHIVE_PAGE }')); } else { echo ((isset($this->_rootref['L_MCHAT_TITLE'])) ? $this->_rootref['L_MCHAT_TITLE'] : ((isset($user->lang['MCHAT_TITLE'])) ? $user->lang['MCHAT_TITLE'] : '{ MCHAT_TITLE }')); } ?></dt>
				</dl>
			</li>
		</ul>
...
<?php } if ($this->_rootref['MCHAT_ENABLE']) {  if (! $this->_rootref['MCHAT_READ_MODE']) {  ?>
	...
	<?php } if (! $this->_rootref['MCHAT_READ_MODE']) {  ?>
			...
			<div style="text-align:center;"><?php echo ((isset($this->_rootref['L_MCHAT_COPYRIGHT'])) ? $this->_rootref['L_MCHAT_COPYRIGHT'] : ((isset($user->lang['MCHAT_COPYRIGHT'])) ? $user->lang['MCHAT_COPYRIGHT'] : '{ MCHAT_COPYRIGHT }')); ?></div>
		</div>
